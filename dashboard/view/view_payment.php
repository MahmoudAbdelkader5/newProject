<a href="?do=add" class="btn btn-info">add payment of trainee </a>
				<br><br>
  ...
  <thead>
    <tr>
      ...
      <th scope="col">type of Subscriptions </th>
...
<?php 
$index = 1;
$select_users = "SELECT * FROM payment";
...
foreach ($result_users as $key) {
	?>
	 <tr>
      ...
      <td><?php if($key['type of Subscriptions'] == "0"){echo "daily";}else{echo "monthly";} ?></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Are You Sure To Delete ( <span style="color: red;"><?php echo $key['name'] . '&nbsp;' . $key['amount']; ?></span>)
      </div>
