<a href="?do=add" class="btn btn-info">Add New trainee</a>
				<br><br>
...
<?php 
$index = 1;
$select_users = "SELECT * FROM trainee";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Are You Sure To Delete User( <span style="color: red;"><?php echo $key['name'] . '&nbsp;' . $key['image']; ?></span>)
      </div>
