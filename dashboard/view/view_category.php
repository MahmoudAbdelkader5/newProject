<a href="?do=add" class="btn btn-info">Add New manager</a>
				<br><br>
...
<?php 
$index = 1;
$select_users = "SELECT * FROM manager";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Are You Sure To Delete manager( <span style="color: red;"><?php echo $key['name'] . '&nbsp;' . $key['image']; ?></span>)
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a href="function/delete_category.php?id=<?php echo $key['id']; ?>" class="btn btn-danger">Confirm</a>
      </div>
    </div>
  </div>
</div>
